...
begin
  ...
  begin
    ...
    FValorMultaParcela := F_MultaAtraso;
...
function TEntityGerarParcelas.setDatapagamento(value: TDateTimePicker): iParcelaOrdem;
begin
  result := self;
  value.DateTime := Date;
end;
...
begin
  ...
  value.Text := CurrToStr(totalJuros);
...
begin
  ...
  value.Text := CurrToStr(FValorMultaParcela);
