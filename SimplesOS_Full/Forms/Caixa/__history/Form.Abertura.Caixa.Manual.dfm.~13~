object formAberturaDeCaixaManual: TformAberturaDeCaixaManual
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'Abertura de caixa manual'
  ClientHeight = 407
  ClientWidth = 841
  Color = clBtnFace
  ...
  object GroupBox2: TGroupBox
    ...
    Height = 144
    Align = alTop
    Caption = 'Informa'#231#245'es do '#250'ltimo novo caixa'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Segoe UI'
    ...
    object edtValorDeEncerramento: TCurrencyEdit
      Left = 321
      Top = 72
      Width = 146
      Height = 25
  ...
  object GroupBox1: TGroupBox
    ...
    Height = 152
    Align = alTop
    Caption = 'Informa'#231#245'es do novo caixa'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Segoe UI'
    ...
    object edtValorAnterior: TCurrencyEdit
      Left = 271
      Top = 64
      Width = 121
      Height = 25
  ...
  object s_Fechamento: TDataSource
    OnDataChange = s_FechamentoDataChange
    Left = 720
    Top = 81
  end
  object s_Abertura: TDataSource
    OnDataChange = s_AberturaDataChange
    Left = 720
    Top = 137
  end
end
