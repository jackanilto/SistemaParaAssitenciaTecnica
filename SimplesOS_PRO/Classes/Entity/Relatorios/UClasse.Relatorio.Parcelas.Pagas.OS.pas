...
begin
  ...
  FGravarLog.getJanela('Relatório Parcelas Recebidas').getCodigoFuncionario
    (funcionarioLogado);
...
begin
  ...
  pasta.Caption := 'Relatório das parcelas pagas';
  pasta.visible := true;

  pasta.cells[1, 1] := 'Parcela';
  pasta.cells[1, 2] := 'Cód. OS';
  ...
  pasta.cells[1, 14] := 'Horário do pagamento';
