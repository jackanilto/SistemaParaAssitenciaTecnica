...
begin
  ...
  pasta.cells[1, 3] := 'Horário de abertura';
  pasta.cells[1, 4] := 'Cód. Funcionário abertura';
  pasta.cells[1, 5] := 'Nome funcionário abertura';
  pasta.cells[1, 6] := 'Valor anterior';
  pasta.cells[1, 7] := 'Valor informado';
  pasta.cells[1, 8] := 'Data de encerramento';
  pasta.cells[1, 9] := 'Horário de encerramento';
  pasta.cells[1, 10] := 'Cód. Funcionário encerramento';
  pasta.cells[1, 11] := 'Nome funcionário encerramento';
...
begin
  ...
  begin
    ...
    FieldByName('ID').DisplayLabel := 'Código abertura';
    ...
    FieldByName('NOME_FUNCIONARIO_ABERTURA').DisplayLabel := 'Funcionário(Abertura)';
    ...
    FieldByName('NOME_FUNCIONARIO_ENCERRAMENTO').DisplayLabel := 'Funcionário(Encerramento)';
