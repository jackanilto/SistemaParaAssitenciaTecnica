...
begin
  ...
  pasta.cells[1, 11] := 'Soluççao do problema';
  ...
  pasta.cells[1, 26] := 'Saída';
  pasta.cells[1, 27] := 'Hora da saída';
  pasta.cells[1, 28] := 'Data base para o vencimento';
  pasta.cells[1, 29] := 'Cód. Técnico';
  pasta.cells[1, 30] := 'Técnico';
  pasta.cells[1, 31] := 'Observação';
