...
begin
  ...
  FGravarLog.getJanela('Relatório de Vendas por Funcionários').getCodigoFuncionario
    (funcionarioLogado);
...
begin
  ...
  FQuery.TQuery.FieldByName('ID_FUNCIONARIO').DisplayLabel := 'Cód. Funcionário';
  FQuery.TQuery.FieldByName('NOME_FUNCIONARIO').DisplayLabel := 'Nome do funcionário';
