...
Type
  ...
  public
    ...
    procedure inserirDados(host, local, user, pass, port: string);
...
procedure TConfigConexaoBanco.inserirDados(host, local, user, pass, port: string);
begin
  ...
  try
    ...
    FQueryConf.retornarQuery.FieldByName('user').AsString := user;
    FQueryConf.retornarQuery.FieldByName('password').AsString := pass;
    FQueryConf.retornarQuery.FieldByName('port').AsString := port;
...
begin
  ...
  try
    ...
    FQueryConf.retornarQuery.FieldByName('user').AsString := 'sysdba';
    FQueryConf.retornarQuery.FieldByName('password').AsString := 'masterkey';
    FQueryConf.retornarQuery.FieldByName('port').AsString := '3050';
