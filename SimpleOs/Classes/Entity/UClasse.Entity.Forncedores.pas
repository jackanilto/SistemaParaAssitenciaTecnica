...
begin
  ...
  FGravarLog.getJanela('Cadastro forncedores').getCodigoFuncionario(funcionarioLogado);
...
begin
  ...
  pasta.Caption := 'Relatório de Fornecedores';
  pasta.visible := true;
  ...
  try
    ...
    begin
      ...
      pasta.cells[linha, 17] := FQuery.TQuery.FieldByName
        ('FUINCIONARIO_CADASTRO').AsInteger;
