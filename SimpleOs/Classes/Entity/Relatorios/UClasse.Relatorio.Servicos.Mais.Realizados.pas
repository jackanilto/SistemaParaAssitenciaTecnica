...
begin
  ...
  FGravarLog.getJanela('Relatório serviços mais realizados').getCodigoFuncionario
    (funcionarioLogado);
...
begin
  ...
  pasta.Caption := 'Relatório Serviços mais / menos realizados';
  pasta.visible := true;
...
begin
  ...
  FQuery.TQuery.FieldByName('ID_SERVICOS').DisplayLabel := 'Cód. Serviços';
  FQuery.TQuery.FieldByName('SERVICO').DisplayLabel := 'Serviços';
